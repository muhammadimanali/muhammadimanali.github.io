(() => {
  ...
  // ns-hugo:/home/ecs-user/my-hugo-site/themes/hugo-tania/assets/js/fuse.js
  var require_fuse = __commonJS({
    "ns-hugo:/home/ecs-user/my-hugo-site/themes/hugo-tania/assets/js/fuse.js"(exports, module) {
  ...
  var Search = class {
    ...
    initFuse() {
      ...
      fetch("/index.json").then((response) => {
        ...
        let fuse = new import_fuse.default(pages, fuseOptions);
        this.fuse = fuse;
      }).catch(function(err) {
