(() => {
  // ns-hugo:/home/ecs-user/my-hugo-site/themes/hugo-tania/assets/ts/colorScheme.ts
  ...
  // ns-hugo:/home/ecs-user/my-hugo-site/themes/hugo-tania/assets/ts/copyButton.ts
  ...
  // ns-hugo:/home/ecs-user/my-hugo-site/themes/hugo-tania/assets/ts/footnotes.ts
  var removeEl = (el) => {
    if (!el)
      return;
  ...
  var renderFootnotes = function() {
    ...
    document.querySelectorAll(".footnotes, #refs").forEach(function(fn) {
      ...
      if (fn.id === "refs")
        return items.length === 0 && removeEl(fn);
      if (items.length !== 2 || items[0].tagName !== "HR" || items[1].tagName !== "OL")
        return;
